        ...
        <div class="content col-sm-12 col-md-6" style="margin-bottom: 50px;">
            <article class="post-wrap" data-animation="fadeInUp" data-animation-delay="100">
                ...
                <div class="post-header">
                    <h2 class="post-title"><a href="san-pham-'.utf8tourl($row['name_post']).'-'.$row['id_post'].'.html">'.$row['name_post'].'</a></h2>
                    <div class="post-meta">
                ...
                <div class="post-footer">
                    <span class="post-readmore">
                        <a href="san-pham-'.utf8tourl($row['name_post']).'-'.$row['id_post'].'.html" class="btn btn-theme btn-theme-transparent">Đọc tiếp</a>
                    </span>
                </div>
            </article>
        </div>';
