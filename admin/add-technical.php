<?php
    ...
    include_once '../model/show_kind_technical.php';
...
<html lang="en">
    <head>
        <?php 
            if ($kiem_tra == 1) {
                echo "<title>Sửa bài viết kỹ thuật</title>";
            } else {
                echo "<title>Thêm bài viết kỹ thuật</title>";
            }
        ?>
                            ...
                            <div class="col-md-10 col-md-offset-1">
                                <div class="p-20">
                                    <div class="">
                                        <?php 
                                            if ($kiem_tra == 1) {
                                                echo "<form action='../model/update_technical.php' method='post' enctype='multipart/form-data'>
                                                <input type='hidden' name='id_post' value='{$id_post}'>
                                                <input type='hidden' name='avatar' value='{$avatar}'>
                                                ";
                                            } else {
                                                echo "<form action='../model/add_technical.php' method='post' enctype='multipart/form-data'>";
                                            }
                                        ?>
