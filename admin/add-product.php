<?php
    ...
    include_once '../model/show_company.php';
    include_once '../model/show_kinds_company.php';
    if ($price == "") {
...
<html lang="en">
    <head>
        <?php 
            if ($kiem_tra == 1) {
                echo "<title>Sửa sản phẩm tin tức</title>";
            } else {
                echo "<title>Thêm sản phẩm tin tức</title>";
            }
        ?>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <?php 
                                        if ($kiem_tra == 1) {
                                            echo "<h4 class='page-title'>Sửa sản phẩm: $name_post</h4>";
                                        } else {
                                            echo "<h4 class='page-title'>Thêm sản phẩm</h4>";
                                        }
                                    ?>
                            ...
                            <div class="col-md-10 col-md-offset-1">
                                <div class="p-20">
                                    <div class="">
                                        <?php 
                                            if ($kiem_tra == 1) {
                                                echo "<form action='../model/update_product.php' method='post' enctype='multipart/form-data'>
                                                <input type='hidden' name='id_post' value='{$id_post}'>
                                                <input type='hidden' name='avatar' value='{$avatar}'>
                                                ";
                                            } else {
                                                echo "<form action='../model/add_product.php' method='post' enctype='multipart/form-data'>";
                                            }
                                        ?>
                                            ...
                                            <div class="form-group m-b-20">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $price ?>" name="price" placeholder="Giá">
                                            </div>
                                            
                                            <div class="form-group m-b-20">
                                                <label for="property-desc">Giới thiệu ngắn </label>
                                                <textarea id="summernote1" class="form-control" id="property-desc" rows="5" name="description-n" required><?php echo $description_n; ?></textarea>
                                            </div>
                                            ...
                                            <div class="form-group m-b-20">
                                                <div class="form-group m-b-20">
                                                    <label>Sản phẩm thuộc công ty <span style="color: #f44336;">*</span></label>
                                                    <div class="row">
                                                        <?php
                                                        if ($kiem_tra == 1) {
                                                            get_company_update($id_post);
                                                        } else {
                                                            get_company_add();
                                                        }
                                                        ?>
                                            ...
                                            <div class="form-group m-b-20">
                                                <div class="form-group m-b-20">
                                                    ...
                                                    <div class="row">
                                                        <?php
                                                        if ($kiem_tra == 1) {
                                                            get_kinds_company_update($id_post);
                                                        } else {
                                                            get_kinds_company_add();
                                                        }
                                                        ?>
                                                    </div> <!-- end row -->
                                                </div>
