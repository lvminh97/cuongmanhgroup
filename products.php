...
<head>
    ...
    <title>Sản phẩm | Cường Mạnh Group</title>
</head>
...
<body id="home" class="wide body-light sub-page">
    ...
    <div class="wrapper">
        ...
        ?>
        <!-- /HEADER -->
        <div class="banner-top" style="background: url(views/assets/img/banner/bg4.png) center center / cover;">
            <?php include_once 'views/components/company-menu.php'; ?>
            <h1 style="line-height: 140px;">SẢN PHẨM</h1>
        </div>
        <!-- Content area -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <section id="content" class="content col-sm-8 col-md-9">
                            <?php include_once 'views/show/show_all_product.php'; ?>
                        </section>
                        <!-- Content -->
